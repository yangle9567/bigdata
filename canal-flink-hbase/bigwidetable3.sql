...
CREATE TABLE hbase (
   rowkey STRING,
   cf1 ROW<id STRING,article_id STRING,tag_id STRING>,
...
insert into hbase select rowkey,Row(id,article_id,tag_id) from (select article_id as rowkey,article_id as id,article_id,tag_id from youhui_tag_type_item) t;
