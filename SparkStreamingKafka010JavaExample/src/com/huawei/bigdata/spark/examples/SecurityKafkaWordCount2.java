 ...
 */
public class SecurityKafkaWordCount2
{
  public static void main(String[] args) throws Exception {// C://tmp host1:21007 mytopic 1
  ...
  private static JavaStreamingContext createContext(String[] args) throws Exception {
    ...
    //sparkConf.set("spark.executor.extraJavaOptions", "-Djava.security.auth.login.config=D://workspace5//SparkStreamingKafka010JavaExample//conf//jaas.conf");
    //sparkConf.set("spark.executor.extraJavaOptions", "-Djava.security.auth.login.config=/root/conf/jaas.conf");
